...
${OBJECTDIR}/_ext/5257efb8/ht_main.o: ../examples/ht_main.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5257efb8/ht_main.o ../examples/ht_main.c

${OBJECTDIR}/_ext/511e4115/hash_file.o: ../src/hash_file.c
	${MKDIR} -p ${OBJECTDIR}/_ext/511e4115
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/hash_file.o ../src/hash_file.c

${OBJECTDIR}/_ext/511e4115/hp_file.o: ../src/hp_file.c
	${MKDIR} -p ${OBJECTDIR}/_ext/511e4115
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/hp_file.o ../src/hp_file.c
...
${TESTDIR}/_ext/5257efb8/hp_main.o: ../examples/hp_main.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/5257efb8/hp_main.o ../examples/hp_main.c
...
${OBJECTDIR}/_ext/5257efb8/ht_main_nomain.o: ${OBJECTDIR}/_ext/5257efb8/ht_main.o ../examples/ht_main.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5257efb8/ht_main_nomain.o ../examples/ht_main.c;\
	else  \
...
${OBJECTDIR}/_ext/511e4115/hash_file_nomain.o: ${OBJECTDIR}/_ext/511e4115/hash_file.o ../src/hash_file.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/hash_file_nomain.o ../src/hash_file.c;\
	else  \
...
${OBJECTDIR}/_ext/511e4115/hp_file_nomain.o: ${OBJECTDIR}/_ext/511e4115/hp_file.o ../src/hp_file.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Wall -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e4115/hp_file_nomain.o ../src/hp_file.c;\
	else  \
